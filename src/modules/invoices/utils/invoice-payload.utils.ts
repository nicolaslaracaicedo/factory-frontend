...
const normalizeDetalle = (value: UnknownRecord): FacturaDetalle => ({
  ...
  subtotal: toNumber(value.subtotal, 0) || undefined,
  valor_iva: toNumber(value.valor_iva, 0) || undefined,
  total: toNumber(value.total, 0) || undefined,
...
const normalizeFactura = (value: UnknownRecord): FacturaItem => ({
  ...
  vuelto: toNumber(value.vuelto, 0) || undefined,
  ...
  iva_total: toNumber(value.iva_total ?? value.total_iva, 0) || undefined,
