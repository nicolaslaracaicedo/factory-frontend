...
export const normalizeDetalle = (data: unknown): LiquidacionCompraDetalle => {
  ...
  return {
    ...
    codigo_ice: toText(record.codigo_ice, undefined),
    porcentaje_ice: toNumber(record.porcentaje_ice, undefined),
    valor_unitario_irbpnr: toNumber(record.valor_unitario_irbpnr, undefined),
    subtotal: toNumber(record.subtotal, undefined),
    iva: toNumber(record.valor_iva ?? record.iva, undefined),
    ice: toNumber(record.ice, undefined),
    irbpnr: toNumber(record.irbpnr, undefined),
